...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'events', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'description'];
        }
     ...
     * {@inheritDoc}
     */
    public function addEvent(\App\Entity\Event $event): \App\Entity\Category
    {
     ...
     * {@inheritDoc}
     */
    public function removeEvent(\App\Entity\Event $event): \App\Entity\Category
    {
