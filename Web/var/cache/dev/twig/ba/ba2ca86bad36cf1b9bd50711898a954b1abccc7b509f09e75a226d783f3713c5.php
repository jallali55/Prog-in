...
class __TwigTemplate_94445c0ccada916c59091fcc34ee920bcc19d5cc87785acf7ac789678e79571f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("baseBack.html.twig", "product/index.html.twig", 1);
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            echo "</td>
                <td>";
            // line 26
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["product"], "pricer", [], "any", false, false, false, 26), "html", null, true);
            echo "</td>
                <td>";
            // line 27
            ...
            echo "\">
                        ...
                        <li class=\"list-inline-item\">
                            <a href=\"";
            // line 38
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_show", ["id" => twig_get_attribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 38)]), "html", null, true);
            echo "\">
                                <button class=\"btn btn-danger btn-sm rounded-0\" type=\"button\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"show\">
              ...
              <!--      <a href=\"";
            // line 44
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_show", ["id" => twig_get_attribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 44)]), "html", null, true);
            echo "\">
                    ...
                    <a href=\"";
            // line 48
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 48)]), "html", null, true);
            echo "\">
    ...
    <div class=\"row mt-3\">
        ...
        echo "\">
                <center>
                    <button type=\"submit\" class=\"btn btn-light btn-round px-5\">Ajouter un produit</button>
                </center></a>
        </div>
        <div class=\"col-lg-3\"></div>
    </div><!--End Row-->
...
";
    ...
    {
        return array (  192 => 66,  182 => 58,  173 => 54,  162 => 48,  155 => 44,  146 => 38,  137 => 32,  129 => 27,  125 => 26,  121 => 25,  117 => 24,  113 => 23,  110 => 22,  105 => 21,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "product/index.html.twig", "C:\\wamp64\\www\\Prog-In-malek_dev\\templates\\product\\index.html.twig");
    }
}
