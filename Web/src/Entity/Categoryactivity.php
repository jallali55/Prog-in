...
class Categoryactivity
{
    ...
    public function getNameCategoryActivity(): ?string
    {
        return $this->nameCategoryActivity;
    }

    public function setNameCategoryActivity(string $nameCategoryActivity): self
    {
